  ...
  return (
    <div className="bg-zinc-900 border border-gray-700 p-6 rounded-xl shadow-lg max-w-xl mx-auto mt-5">
      ...
      {!isFirebaseConfigured && (
        <div className="mb-4 rounded-lg border border-amber-500 bg-amber-500/10 p-3 text-sm text-amber-200">
          Firebase belum dikonfigurasi. Tambahkan VITE_FIREBASE_API_KEY, VITE_FIREBASE_AUTH_DOMAIN,
          VITE_FIREBASE_PROJECT_ID, VITE_FIREBASE_STORAGE_BUCKET, VITE_FIREBASE_MESSAGING_SENDER_ID,
          dan VITE_FIREBASE_APP_ID di file .env.
        </div>
      )}
